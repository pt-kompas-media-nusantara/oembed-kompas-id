...
function routes (app: Express) {
   ...
   *     description: Rute untuk mengambil konten oembed post instagram, memerlukan kueri `url` (wajib), `omitscript` (boleh kosong), `maxwidth` (boleh kosong) dan `hidecaption` (boleh kosong).
   *     parameters:
   *       - in: query
   *         name: url
   *         description: URL ke post bersangkutan
   ...
   *         style: form
   *         allowEmptyValue: false
   *         example: https://www.instagram.com/p/CYi8gCwLD61/
   *       - in: query
   *         name: omitscript
   *         description: Menentukan apakah tag `<script>` disertakan dalam bodi respons dari Facebook. Nilai default `false`
   *         required: false
   ...
   *       - in: query
   *         name: hidecaption
   *         description: Menentukan apakah caption ditampilkan atau tidak. Nilai default `false`
   *         required: false
   *         allowEmptyValue: true
   *         example: true
   *       - in: query
   *         name: maxwidth
   *         description: Menentukan maxwidth container (max 658, min 320)
   *         required: false
   *         allowEmptyValue: true
   *         example: 420
